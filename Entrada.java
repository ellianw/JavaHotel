...
public class Entrada {
    ...
    public static String leiaString(String prompt, String initialValue) {
        ...
        while (!validResponse) {
            ...
            UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Courier New", Font.BOLD, 18))); // Aqui você muda o nome e tamanho da fonte.
    ...
    public static boolean leiaBoolean(String prompt, String trueText, String falseText) {
        ...
        while (!validResponse) {
            ...
            if (result == JOptionPane.YES_OPTION || result == JOptionPane.NO_OPTION) // CORRECTED from 0:1
            {
                ...
                commentArray[1] = "Seleï¿½ï¿½o incorreta: escolha os botï¿½es true ou false";
            }
        }
        return (result == 0);
    }
        ...
        while (!validResponse) {
            ...
            if (input == JOptionPane.UNINITIALIZED_VALUE) {
                ...
                if (result == null) { // EA: added for completnes, but is this situation possible?
                    commentArray[1] = "Valor inteiro invï¿½lido:";
                    commentArray[2] = "Entre com um valor inteiro vï¿½lido";
                } else {
                    try {
                        ...
                        commentArray[1] = "Valor inteiro invï¿½lido: " + result;
                        commentArray[2] = "Entre com um valor inteiro vï¿½lido";
    ...
    public static double leiaDouble(String prompt, String initialValue) {
        ...
        while (!validResponse) {
            ...
            Object input = optionPane.getInputValue();
            if (input == JOptionPane.UNINITIALIZED_VALUE) {
                commentArray[1] = "Precisa entrar com um valor fracionï¿½rio"; // EA: explanatory text added
                commentArray[2] = EMPTY_STRING;
            } else {
                String result = (String) input;
                if (result == null) { // EA: added for completnes, but is this situation possible?
                    commentArray[1] = "valor fracionï¿½rio invï¿½lido:";
                    commentArray[2] = "Entre com um valor fracionï¿½rio vï¿½lido";
                } else {
                    ...
                    try {
                        ...
                        commentArray[1] = "Valor fracionï¿½rio invï¿½lido: " + result;
                        commentArray[2] = "Entre com um valor fracionï¿½rio vï¿½lido";
